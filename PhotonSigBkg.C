#define PhotonSigBkg_cxx
#include "PhotonSigBkg.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>


void PhotonSigBkg::Loop()
{
//   In a ROOT session, you can do:
//      root> .L PhotonSigBkg.C
//      root> PhotonSigBkg t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nentries = fChain->GetEntriesFast();
	...
	TFile file_out("PhotonSigBkgLoopOutput.root","RECREATE");
	...
	TTree *PhotonSigBkgTree = new TTree("PhotonSigBkgTree","Photon Signal Background Tree");
...
//   Bool_t          out_Photon1_isDenominatorObj;
   ...
   Int_t           out_nPV;
	...
	PhotonSigBkgTree->Branch("Photon1_pt",&out_Photon1_pt,"Photon1_pt/D");
	PhotonSigBkgTree->Branch("Photon1_eta",&out_Photon1_eta,"Photon1_eta/D");
	PhotonSigBkgTree->Branch("Photon1_phi",&out_Photon1_phi,"Photon1_phi/D");
	PhotonSigBkgTree->Branch("Photon1_scEta",&out_Photon1_scEta,"Photon1_scEta/D");
	PhotonSigBkgTree->Branch("Photon1_scPhi",&out_Photon1_scPhi,"Photon1_scPhi/D");
	PhotonSigBkgTree->Branch("Photon1_rho",&out_Photon1_rho,"Photon1_rho/D");
	PhotonSigBkgTree->Branch("Photon1_chargedHadIso03",&out_Photon1_chargedHadIso03,"Photon1_chargedHadIso03/D");
	PhotonSigBkgTree->Branch("Photon1_neutralHadIso03",&out_Photon1_neutralHadIso03,"Photon1_neutralHadIso03/D");
	PhotonSigBkgTree->Branch("Photon1_photonIso03",&out_Photon1_photonIso03,"Photon1_photonIso03/D");
	PhotonSigBkgTree->Branch("Photon1_rhoCorChargedHadIso03",&out_Photon1_rhoCorChargedHadIso03,"Photon1_rhoCorChargedHadIso03/D");
	PhotonSigBkgTree->Branch("Photon1_rhoCorNeutralHadIso03",&out_Photon1_rhoCorNeutralHadIso03,"Photon1_rhoCorNeutralHadIso03/D");
	PhotonSigBkgTree->Branch("Photon1_rhoCorPhotonIso03",&out_Photon1_rhoCorPhotonIso03,"Photon1_rhoCorPhotonIso03/D");
	PhotonSigBkgTree->Branch("Photon1_corPhotonIso03",&out_Photon1_corPhotonIso03,"Photon1_corPHotonIso03/D");
	PhotonSigBkgTree->Branch("Photon1_hadTowerOverEm",&out_Photon1_hadTowerOverEm,"Photon1_hadTowerOverEm/D");
	PhotonSigBkgTree->Branch("Photon1_hadronicOverEm",&out_Photon1_hadronicOverEm,"Photon1_hadronicOverEm/D");
	PhotonSigBkgTree->Branch("Photon1_r9",&out_Photon1_r9,"Photon1_r9/D");
	PhotonSigBkgTree->Branch("Photon1_r9_5x5",&out_Photon1_r9_5x5,"Photon1_r9_5x5/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIetaIeta",&out_Photon1_sigmaIetaIeta,"Photon1_sigmaIetaIeta/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIetaIeta5x5",&out_Photon1_sigmaIetaIeta5x5,"Photon1_sigmaIetaIeta5x5/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaEtaEta",&out_Photon1_sigmaEtaEta,"Photon1_sigmaEtaEta/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIphiIphi",&out_Photon1_sigmaIphiIphi,"Photon1_sigmaIphiIphi/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIphiIphi5x5",&out_Photon1_sigmaIphiIphi5x5,"Photon1_sigmaIphiIphi5x5/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIetaIphi",&out_Photon1_sigmaIetaIphi,"Photon1_sigmaIetaIphi/D");
	PhotonSigBkgTree->Branch("Photon1_sigmaIetaIphi5x5",&out_Photon1_sigmaIetaIphi5x5,"Photon1_sigmaIetaIphi5x5/D");
	PhotonSigBkgTree->Branch("Photon1_maxEnergyXtal",&out_Photon1_maxEnergyXtal,"Photon1_maxEnergyXtal/D");
	PhotonSigBkgTree->Branch("Photon1_iEta",&out_Photon1_iEta,"Photon1_iEta/D");
	PhotonSigBkgTree->Branch("Photon1_iPhi",&out_Photon1_iPhi,"Photon1_iPhi/D");
//	PhotonSigBkgTree->Branch("Photon1_alphaHighPtID",&out_Photon1_alphaHighPtID,"Photon1_alphaHighPtID/D");
//	PhotonSigBkgTree->Branch("Photon1_kappaHighPtID",&out_Photon1_kappaHighPtID,"Photon1_kappaHighPtID/D");
//	PhotonSigBkgTree->Branch("Photon1_phoEAHighPtID",&out_Photon1_phoEAHighPtID,"Photon1_phoEAHighPtID/D");
//	PhotonSigBkgTree->Branch("Photon1_chEAegmID",&out_Photon1_chEAegmID,"Photon1_chEAegmID/D");
//	PhotonSigBkgTree->Branch("Photon1_nhEAegmID",&out_Photon1_nhEAegmID,"Photon1_nhEAegmID/D");
//	PhotonSigBkgTree->Branch("Photon1_phoEAegmID",&out_Photon1_phoEAegmID,"Photon1_phoEAegmID/D");
	PhotonSigBkgTree->Branch("Photon1_passEGMLooseID",&out_Photon1_passEGMLooseID,"Photon1_passEGMLooseID/O");
	PhotonSigBkgTree->Branch("Photon1_passEGMMediumID",&out_Photon1_passEGMMediumID,"Photon1_passEGMMediumID/O");
	PhotonSigBkgTree->Branch("Photon1_passEGMTightID",&out_Photon1_passEGMTightID,"Photon1_passEGMTightID/O");
	PhotonSigBkgTree->Branch("Photon1_isEB",&out_Photon1_isEB,"Photon1_isEB/O");
	PhotonSigBkgTree->Branch("Photon1_isEBEtaGap",&out_Photon1_isEBEtaGap,"Photon1_isEBEtaGap/O");
	PhotonSigBkgTree->Branch("Photon1_isEBPhiGap",&out_Photon1_isEBPhiGap,"Photon1_isEBPhiGap/O");
	PhotonSigBkgTree->Branch("Photon1_isEBEEGap",&out_Photon1_isEBEEGap,"Photon1_isEBEEGap/O");
	PhotonSigBkgTree->Branch("Photon1_passElectronVeto",&out_Photon1_passElectronVeto,"Photon1_passElectronVeto/O");
	PhotonSigBkgTree->Branch("Photon1_passHTowOverE",&out_Photon1_passHTowOverE,"Photon1_passHTowOverE/O");
	PhotonSigBkgTree->Branch("Photon1_passChIso",&out_Photon1_passChIso,"Photon1_passChIso/O");
	PhotonSigBkgTree->Branch("Photon1_passCorPhoIso",&out_Photon1_passCorPhoIso,"Photon1_passCorPhoIso/O");
	PhotonSigBkgTree->Branch("Photon1_passSieie",&out_Photon1_passSieie,"Photon1_passSieie/O");
	PhotonSigBkgTree->Branch("Photon1_passHighPtID",&out_Photon1_passHighPtID,"Photon1_passHighPtID/O");
//	PhotonSigBkgTree->Branch("Photon1_passChIsoDenom",&out_Photon1_passChIsoDenom,"Photon1_passChIsoDenom/O");
//	PhotonSigBkgTree->Branch("Photon1_passCorPhoIsoDenom",&out_Photon1_passCorPhoIsoDenom,"Photon1_passCorPhoIsoDenom/O");
//	PhotonSigBkgTree->Branch("Photon1_isFakeable",&out_Photon1_isFakeable,"Photon1_isFakeable/O");
//	PhotonSigBkgTree->Branch("Photon1_isNumeratorObjCand",&out_Photon1_isNumeratorObjCand,"Photon1_isNumeratorObjCand/O");
//	PhotonSigBkgTree->Branch("Photon1_isDenominatorObj",&out_Photon1_isDenominatorObj,"Photon1_isDenominatorObj/O");
	PhotonSigBkgTree->Branch("Photon1_isSaturated",&out_Photon1_isSaturated,"Photon1_isSaturated/O");
	PhotonSigBkgTree->Branch("Event_npv_true",&out_Event_npv_true,"Event_npv_true/I");
	PhotonSigBkgTree->Branch("nPV",&out_nPV,"nPV/I");
	PhotonSigBkgTree->Branch("Photon1_res",&Photon1_res,"Photon1_res/D");
//	PhotonSigBkgTree->Branch("p1eb_classify",&p1eb_classify,"p1eb_classify/O");
    PhotonSigBkgTree->Branch("p1eb_fit2_classify",&p1eb_fit2_classify,"p1eb_fit2_classify/O");
//	PhotonSigBkgTree->Branch("p1eb_fitsigma",&p1eb_fitsigma,"p1eb_fitsigma/D");
    PhotonSigBkgTree->Branch("p1eb_fit2sigma",&p1eb_fit2sigma,"p1eb_fit2sigma/D");
	PhotonSigBkgTree->Branch("p1eb_bad_classify",&p1eb_bad_classify,"p1eb_bad_classify/O");
...
//	out_Photon1_isDenominatorObj = Photon1_isDenominatorObj;
	...
	if ((p1eb_bad_classify == 1) or (p1eb_fit2_classify == 0)) {
	PhotonSigBkgTree->Fill();
	}
...
PhotonSigBkgTree->Write();

file_out.ls();
file_out.Close();
}// end Photon Sig Bkg Loop
