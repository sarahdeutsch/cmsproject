...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nentries = fChain->GetEntriesFast();
	...
	TFile file_out("PhotonSigLoopOutput.root","RECREATE");
	...
	TTree *PhotonSigTree = new TTree("PhotonSigTree","Photon Signal Tree");
...
//   Bool_t          out_Photon1_isDenominatorObj;
   ...
   Int_t           out_nPV;
	...
	PhotonSigTree->Branch("Photon1_pt",&out_Photon1_pt,"Photon1_pt/D");
	PhotonSigTree->Branch("Photon1_eta",&out_Photon1_eta,"Photon1_eta/D");
	PhotonSigTree->Branch("Photon1_phi",&out_Photon1_phi,"Photon1_phi/D");
	PhotonSigTree->Branch("Photon1_scEta",&out_Photon1_scEta,"Photon1_scEta/D");
	PhotonSigTree->Branch("Photon1_scPhi",&out_Photon1_scPhi,"Photon1_scPhi/D");
	PhotonSigTree->Branch("Photon1_rho",&out_Photon1_rho,"Photon1_rho/D");
	PhotonSigTree->Branch("Photon1_chargedHadIso03",&out_Photon1_chargedHadIso03,"Photon1_chargedHadIso03/D");
	PhotonSigTree->Branch("Photon1_neutralHadIso03",&out_Photon1_neutralHadIso03,"Photon1_neutralHadIso03/D");
	PhotonSigTree->Branch("Photon1_photonIso03",&out_Photon1_photonIso03,"Photon1_photonIso03/D");
	PhotonSigTree->Branch("Photon1_rhoCorChargedHadIso03",&out_Photon1_rhoCorChargedHadIso03,"Photon1_rhoCorChargedHadIso03/D");
	PhotonSigTree->Branch("Photon1_rhoCorNeutralHadIso03",&out_Photon1_rhoCorNeutralHadIso03,"Photon1_rhoCorNeutralHadIso03/D");
	PhotonSigTree->Branch("Photon1_rhoCorPhotonIso03",&out_Photon1_rhoCorPhotonIso03,"Photon1_rhoCorPhotonIso03/D");
	PhotonSigTree->Branch("Photon1_corPhotonIso03",&out_Photon1_corPhotonIso03,"Photon1_corPHotonIso03/D");
	PhotonSigTree->Branch("Photon1_hadTowerOverEm",&out_Photon1_hadTowerOverEm,"Photon1_hadTowerOverEm/D");
	PhotonSigTree->Branch("Photon1_hadronicOverEm",&out_Photon1_hadronicOverEm,"Photon1_hadronicOverEm/D");
	PhotonSigTree->Branch("Photon1_r9",&out_Photon1_r9,"Photon1_r9/D");
	PhotonSigTree->Branch("Photon1_r9_5x5",&out_Photon1_r9_5x5,"Photon1_r9_5x5/D");
	PhotonSigTree->Branch("Photon1_sigmaIetaIeta",&out_Photon1_sigmaIetaIeta,"Photon1_sigmaIetaIeta/D");
	PhotonSigTree->Branch("Photon1_sigmaIetaIeta5x5",&out_Photon1_sigmaIetaIeta5x5,"Photon1_sigmaIetaIeta5x5/D");
	PhotonSigTree->Branch("Photon1_sigmaEtaEta",&out_Photon1_sigmaEtaEta,"Photon1_sigmaEtaEta/D");
	PhotonSigTree->Branch("Photon1_sigmaIphiIphi",&out_Photon1_sigmaIphiIphi,"Photon1_sigmaIphiIphi/D");
	PhotonSigTree->Branch("Photon1_sigmaIphiIphi5x5",&out_Photon1_sigmaIphiIphi5x5,"Photon1_sigmaIphiIphi5x5/D");
	PhotonSigTree->Branch("Photon1_sigmaIetaIphi",&out_Photon1_sigmaIetaIphi,"Photon1_sigmaIetaIphi/D");
	PhotonSigTree->Branch("Photon1_sigmaIetaIphi5x5",&out_Photon1_sigmaIetaIphi5x5,"Photon1_sigmaIetaIphi5x5/D");
	PhotonSigTree->Branch("Photon1_maxEnergyXtal",&out_Photon1_maxEnergyXtal,"Photon1_maxEnergyXtal/D");
	PhotonSigTree->Branch("Photon1_iEta",&out_Photon1_iEta,"Photon1_iEta/D");
	PhotonSigTree->Branch("Photon1_iPhi",&out_Photon1_iPhi,"Photon1_iPhi/D");
//	PhotonSigTree->Branch("Photon1_alphaHighPtID",&out_Photon1_alphaHighPtID,"Photon1_alphaHighPtID/D");
//	PhotonSigTree->Branch("Photon1_kappaHighPtID",&out_Photon1_kappaHighPtID,"Photon1_kappaHighPtID/D");
//	PhotonSigTree->Branch("Photon1_phoEAHighPtID",&out_Photon1_phoEAHighPtID,"Photon1_phoEAHighPtID/D");
//	PhotonSigTree->Branch("Photon1_chEAegmID",&out_Photon1_chEAegmID,"Photon1_chEAegmID/D");
//	PhotonSigTree->Branch("Photon1_nhEAegmID",&out_Photon1_nhEAegmID,"Photon1_nhEAegmID/D");
//	PhotonSigTree->Branch("Photon1_phoEAegmID",&out_Photon1_phoEAegmID,"Photon1_phoEAegmID/D");
	PhotonSigTree->Branch("Photon1_passEGMLooseID",&out_Photon1_passEGMLooseID,"Photon1_passEGMLooseID/O");
	PhotonSigTree->Branch("Photon1_passEGMMediumID",&out_Photon1_passEGMMediumID,"Photon1_passEGMMediumID/O");
	PhotonSigTree->Branch("Photon1_passEGMTightID",&out_Photon1_passEGMTightID,"Photon1_passEGMTightID/O");
	PhotonSigTree->Branch("Photon1_isEB",&out_Photon1_isEB,"Photon1_isEB/O");
	PhotonSigTree->Branch("Photon1_isEBEtaGap",&out_Photon1_isEBEtaGap,"Photon1_isEBEtaGap/O");
	PhotonSigTree->Branch("Photon1_isEBPhiGap",&out_Photon1_isEBPhiGap,"Photon1_isEBPhiGap/O");
	PhotonSigTree->Branch("Photon1_isEBEEGap",&out_Photon1_isEBEEGap,"Photon1_isEBEEGap/O");
	PhotonSigTree->Branch("Photon1_passElectronVeto",&out_Photon1_passElectronVeto,"Photon1_passElectronVeto/O");
	PhotonSigTree->Branch("Photon1_passHTowOverE",&out_Photon1_passHTowOverE,"Photon1_passHTowOverE/O");
	PhotonSigTree->Branch("Photon1_passChIso",&out_Photon1_passChIso,"Photon1_passChIso/O");
	PhotonSigTree->Branch("Photon1_passCorPhoIso",&out_Photon1_passCorPhoIso,"Photon1_passCorPhoIso/O");
	PhotonSigTree->Branch("Photon1_passSieie",&out_Photon1_passSieie,"Photon1_passSieie/O");
	PhotonSigTree->Branch("Photon1_passHighPtID",&out_Photon1_passHighPtID,"Photon1_passHighPtID/O");
//	PhotonSigTree->Branch("Photon1_passChIsoDenom",&out_Photon1_passChIsoDenom,"Photon1_passChIsoDenom/O");
//	PhotonSigTree->Branch("Photon1_passCorPhoIsoDenom",&out_Photon1_passCorPhoIsoDenom,"Photon1_passCorPhoIsoDenom/O");
//	PhotonSigTree->Branch("Photon1_isFakeable",&out_Photon1_isFakeable,"Photon1_isFakeable/O");
//	PhotonSigTree->Branch("Photon1_isNumeratorObjCand",&out_Photon1_isNumeratorObjCand,"Photon1_isNumeratorObjCand/O");
//	PhotonSigTree->Branch("Photon1_isDenominatorObj",&out_Photon1_isDenominatorObj,"Photon1_isDenominatorObj/O");
	PhotonSigTree->Branch("Photon1_isSaturated",&out_Photon1_isSaturated,"Photon1_isSaturated/O");
	PhotonSigTree->Branch("Event_npv_true",&out_Event_npv_true,"Event_npv_true/I");
	PhotonSigTree->Branch("nPV",&out_nPV,"nPV/I");
	PhotonSigTree->Branch("Photon1_res",&Photon1_res,"Photon1_res/D");
//	PhotonSigTree->Branch("p1eb_classify",&p1eb_classify,"p1eb_classify/O");
    PhotonSigTree->Branch("p1eb_fit2_classify",&p1eb_fit2_classify,"p1eb_fit2_classify/O");
//	PhotonSigTree->Branch("p1eb_fitsigma",&p1eb_fitsigma,"p1eb_fitsigma/D");
    PhotonSigTree->Branch("p1eb_fit2sigma",&p1eb_fit2sigma,"p1eb_fit2sigma/D");
	PhotonSigTree->Branch("p1eb_bad_classify",&p1eb_bad_classify,"p1eb_bad_classify/O");
